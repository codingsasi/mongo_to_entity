...
namespace Drupal\mongo_to_entity\Controller;
...
class LocationController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\mongo_to_entity\Entity\LocationInterface $location
   *   A Location object.
   *
   * @return array
  ...
  public function revisionOverview(LocationInterface $location) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\mongo_to_entity\LocationInterface $revision */
