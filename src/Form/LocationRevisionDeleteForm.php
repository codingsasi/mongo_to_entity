 ...
 */
class LocationRevisionDeleteForm extends ConfirmFormBase {

  /**
   * The Location revision.
   *
   * @var \Drupal\mongo_to_entity\Entity\LocationInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->LocationStorage->deleteRevision($this->revision->getRevisionId());
