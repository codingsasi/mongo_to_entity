...
/**
 * Class MongoDBCredentialsForm.
 */
class MongoDBCredentialsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'mongo_to_entity.mongodbcredentials',
    ];
  }
  ...
  public function getFormId() {
    return 'mongo_db_credentials_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
   $db_string = 'mongodb://10.0.2.2:27017/Cities';
    ...
    $config = $this->config('mongo_to_entity.mongodbcredentials');
    $form['database_host'] = [
      '#type' => 'textfield',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('mongo_to_entity.mongodbcredentials')
