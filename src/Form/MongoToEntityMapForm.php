 ...
 */
class MongoToEntityMapForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'mongo_to_entity.mongotoentitymap',
    ];
  }
  ...
  public function getFormId() {
    return 'mongo_to_entity_map_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $entity = NULL, $bundle = NULL) {
    ...
    $config = $this->config('mongo_to_entity.mongotoentitymap');
    $form['#_entity'] = $entity;
    $form['#_bundle'] = $bundle;
    $form['#prefix'] = '<div>'
